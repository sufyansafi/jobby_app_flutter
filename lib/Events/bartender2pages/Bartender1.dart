...
import 'bartender2.dart';




class Bartender1 extends StatefulWidget {
  const Bartender1({Key? key}) : super(key: key);

  @override
  State<Bartender1> createState() => _Bartender1State();
}

class _Bartender1State extends State<Bartender1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Bartender2()),
                );
              },
              style: ButtonStyle(
