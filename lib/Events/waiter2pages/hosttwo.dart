...
import '../host.dart';
import 'hostthree.dart';

class Hosttwo extends StatefulWidget {
  const Hosttwo({Key? key}) : super(key: key);

  @override
  State<Hosttwo> createState() => _HosttwoState();
}

class _HosttwoState extends State<Hosttwo> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Hostthree()),
                );
              },
              style: ButtonStyle(
