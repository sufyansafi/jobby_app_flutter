...
class Waiterr1 extends StatefulWidget {
  const Waiterr1({Key? key}) : super(key: key);

  @override
  State<Waiterr1> createState() => _Waiterr1State();
}

class _Waiterr1State extends State<Waiterr1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Waiterr2()),
                );
              },
              style: ButtonStyle(
