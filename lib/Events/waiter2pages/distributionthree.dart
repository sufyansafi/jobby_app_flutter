...
class Distributionthree extends StatefulWidget {
  const Distributionthree({Key? key}) : super(key: key);

  @override
  State<Distributionthree> createState() => _DistributionthreeState();
}

class _DistributionthreeState extends State<Distributionthree> {
  @override
