...
class Waiterr2 extends StatefulWidget {
  const Waiterr2({Key? key}) : super(key: key);

  @override
  State<Waiterr2> createState() => _Waiterr2State();
}

class _Waiterr2State extends State<Waiterr2> {
  @override
