...
class Distrbtion2 extends StatefulWidget {
  const Distrbtion2({Key? key}) : super(key: key);

  @override
  State<Distrbtion2> createState() => _Distrbtion2State();
}

class _Distrbtion2State extends State<Distrbtion2> {
  @override
