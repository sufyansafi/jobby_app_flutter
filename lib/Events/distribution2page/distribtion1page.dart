...
import 'distritbion2.dart';




class Distribtion1 extends StatefulWidget {
  const Distribtion1({Key? key}) : super(key: key);

  @override
  State<Distribtion1> createState() => _Distribtion1State();
}

class _Distribtion1State extends State<Distribtion1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Distrbtion2()),
                );
              },
              style: ButtonStyle(
