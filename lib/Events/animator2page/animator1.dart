...
import 'animator2.dart';





class Animator1 extends StatefulWidget {
  const Animator1({Key? key}) : super(key: key);

  @override
  State<Animator1> createState() => _Animator1State();
}

class _Animator1State extends State<Animator1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Animator2()),
                );
              },
              style: ButtonStyle(
