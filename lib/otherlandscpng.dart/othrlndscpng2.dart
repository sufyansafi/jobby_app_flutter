...
class Otlsj2 extends StatefulWidget {
  const Otlsj2({Key? key}) : super(key: key);

  @override
  State<Otlsj2> createState() => _Otlsj2State();
}

class _Otlsj2State extends State<Otlsj2> {
  @override
