...
import 'package:flutter_application_1/mirror2page/mirrorintl2.dart';
import 'package:flutter_application_1/otherlandscpng.dart/othrlndscpng2.dart';
...
import '../hangwall/hang2.dart';

class Olj1 extends StatefulWidget {
  const Olj1({Key? key}) : super(key: key);

  @override
  State<Olj1> createState() => _Olj1State();
}

class _Olj1State extends State<Olj1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Otlsj2()),
                );
              },
              style: ButtonStyle(
