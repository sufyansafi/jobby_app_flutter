...
import 'package:flutter_application_1/Fixingshelves.dart/fixngshlves.dart';
...
import '../Curtnroad.dart/C2.dart';
import '../Furnituredismnlng.dart/fd2.dart';

class Fixing1 extends StatefulWidget {
  const Fixing1({Key? key}) : super(key: key);

  @override
  State<Fixing1> createState() => _Curtain1State();
}

class _Curtain1State extends State<Fixing1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => FIX2()),
                );
              },
              style: ButtonStyle(
