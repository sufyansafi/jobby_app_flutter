...
class Cleancmp2 extends StatefulWidget {
  const Cleancmp2({Key? key}) : super(key: key);

  @override
  State<Cleancmp2> createState() => _Cleancmp2State();
}

class _Cleancmp2State extends State<Cleancmp2> {
  @override
