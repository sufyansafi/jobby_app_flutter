...
import 'cleanmycmp2.dart';

class Cleancmp1 extends StatefulWidget {
  const Cleancmp1({Key? key}) : super(key: key);

  @override
  State<Cleancmp1> createState() => _Cleancmp1State();
}

class _Cleancmp1State extends State<Cleancmp1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const Cleancmp2()),
                );
              },
              style: ButtonStyle(
