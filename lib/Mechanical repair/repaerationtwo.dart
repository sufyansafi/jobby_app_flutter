...
import 'repeationthree.dart';

class Repatetiontwo extends StatefulWidget {
  const Repatetiontwo({Key? key}) : super(key: key);

  @override
  State<Repatetiontwo> createState() => _RepatetiontwoState();
}

class _RepatetiontwoState extends State<Repatetiontwo> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Repationthree()),
                );
              },
              style: ButtonStyle(
