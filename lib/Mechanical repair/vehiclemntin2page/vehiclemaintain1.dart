...
import 'package:flutter_application_1/Mechanical%20repair/vehiclemntin2page/vehiclemaintain2.dart';
...
class Vehiclemntain1 extends StatefulWidget {
  const Vehiclemntain1({Key? key}) : super(key: key);

  @override
  State<Vehiclemntain1> createState() => _Vehiclemntain1State();
}

class _Vehiclemntain1State extends State<Vehiclemntain1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Vehiclemntain2()),
                );
              },
              style: ButtonStyle(
