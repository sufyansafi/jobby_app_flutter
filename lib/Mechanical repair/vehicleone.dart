...
import 'vehiclethree.dart';

class Vehicletwo extends StatefulWidget {
  const Vehicletwo({Key? key}) : super(key: key);

  @override
  State<Vehicletwo> createState() => _VehicletwoState();
}

class _VehicletwoState extends State<Vehicletwo> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Vehiclethree()),
                );
              },
              style: ButtonStyle(
