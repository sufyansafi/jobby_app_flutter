...
import 'package:flutter_application_1/Mechanical%20repair/vehiclerepeatthree.dart';
...
class Vehiclerreptiontwo extends StatefulWidget {
  const Vehiclerreptiontwo({Key? key}) : super(key: key);

  @override
  State<Vehiclerreptiontwo> createState() => _VehiclerreptiontwoState();
}

class _VehiclerreptiontwoState extends State<Vehiclerreptiontwo> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Vehiclerepatthree()),
                );
              },
              style: ButtonStyle(
