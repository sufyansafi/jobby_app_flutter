...
import 'furniturerr2.dart';

class Furniturr1 extends StatefulWidget {
  const Furniturr1({Key? key}) : super(key: key);

  @override
  State<Furniturr1> createState() => _Furniturr1State();
}

class _Furniturr1State extends State<Furniturr1> {
  @override
  var dropdownValue;
  int groupValue = 2;
  bool firstVal = true;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Furniturer2()),
                );
              },
              style: ButtonStyle(
