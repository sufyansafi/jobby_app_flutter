...
import '../Diy/Layout/furnitureassembly3.dart';

class Furniturer2 extends StatefulWidget {
  const Furniturer2({Key? key}) : super(key: key);

  @override
  State<Furniturer2> createState() => _Furniturer2State();
}

class _Furniturer2State extends State<Furniturer2> {
  @override
