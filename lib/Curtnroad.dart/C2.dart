...
class Curtain2 extends StatefulWidget {
  const Curtain2({Key? key}) : super(key: key);

  @override
  State<Curtain2> createState() => _Curtain2State();
}

class _Curtain2State extends State<Curtain2> {
  @override
