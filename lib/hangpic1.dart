...
import 'hangpic2.dart';
import 'hangwall/hang2.dart';

class Hangpic1 extends StatefulWidget {
  const Hangpic1({Key? key}) : super(key: key);

  @override
  State<Hangpic1> createState() => _Hangpic1State();
}

class _Hangpic1State extends State<Hangpic1> {
  @override
  var dropdownValue;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Hangpic2()),
                );
              },
              style: ButtonStyle(
