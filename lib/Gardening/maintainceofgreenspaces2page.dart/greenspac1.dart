...
import 'package:flutter_application_1/Gardening/maintainceofgreenspaces2page.dart/greenspacing2.dart';
...
class Greenspace1 extends StatefulWidget {
  const Greenspace1({Key? key}) : super(key: key);

  @override
  State<Greenspace1> createState() => _Greenspace1State();
}

class _Greenspace1State extends State<Greenspace1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Greenspace2()),
                );
              },
              style: ButtonStyle(
