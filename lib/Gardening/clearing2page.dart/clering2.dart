...
class Clearing2 extends StatefulWidget {
  const Clearing2({Key? key}) : super(key: key);

  @override
  State<Clearing2> createState() => _Clearing2State();
}

class _Clearing2State extends State<Clearing2> {
  @override
