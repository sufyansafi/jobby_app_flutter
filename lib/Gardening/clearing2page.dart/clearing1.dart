...
import 'clering2.dart';

class Clearing1 extends StatefulWidget {
  const Clearing1({Key? key}) : super(key: key);

  @override
  State<Clearing1> createState() => _Clearing1State();
}

class _Clearing1State extends State<Clearing1> {
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Clearing2()),
                );
              },
              style: ButtonStyle(
