...
import 'lawncare2.dart';

class Lawncare1 extends StatefulWidget {
  const Lawncare1({Key? key}) : super(key: key);

  @override
  State<Lawncare1> createState() => _Lawncare1State();
}

class _Lawncare1State extends State<Lawncare1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Lawncare2()),
                );
              },
              style: ButtonStyle(
