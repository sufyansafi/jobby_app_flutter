...
import 'hedgetrim2.dart';

class Hedgetrim1 extends StatefulWidget {
  const Hedgetrim1({Key? key}) : super(key: key);

  @override
  State<Hedgetrim1> createState() => _Hedgetrim1State();
}

class _Hedgetrim1State extends State<Hedgetrim1> {
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Hedgetrim2()),
                );
              },
              style: ButtonStyle(
