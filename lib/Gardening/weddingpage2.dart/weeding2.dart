...
class Weeding2 extends StatefulWidget {
  const Weeding2({Key? key}) : super(key: key);

  @override
  State<Weeding2> createState() => _Weeding2State();
}

class _Weeding2State extends State<Weeding2> {
  @override
