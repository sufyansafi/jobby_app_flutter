...
import 'tomowlawn2.dart';

class Mowlawn1 extends StatefulWidget {
  const Mowlawn1({Key? key}) : super(key: key);

  @override
  State<Mowlawn1> createState() => _Mowlawn1State();
}

class _Mowlawn1State extends State<Mowlawn1> {
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Mowlawn2()),
                );
              },
              style: ButtonStyle(
