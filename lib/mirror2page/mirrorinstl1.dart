...
class Mirror1 extends StatefulWidget {
  const Mirror1({Key? key}) : super(key: key);

  @override
  State<Mirror1> createState() => _Mirror1State();
}

class _Mirror1State extends State<Mirror1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Mirro2()),
                );
              },
              style: ButtonStyle(
