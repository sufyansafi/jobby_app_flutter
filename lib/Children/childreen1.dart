...
import 'childreen2.dart';



class Childcare1 extends StatefulWidget {
  const Childcare1({Key? key}) : super(key: key);

  @override
  State<Childcare1> createState() => _Childcare1State();
}

class _Childcare1State extends State<Childcare1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Children2()),
                );
              },
              style: ButtonStyle(
