...
import 'chefathomw2.dart';

class Chefathome1 extends StatefulWidget {
  const Chefathome1({Key? key}) : super(key: key);

  @override
  State<Chefathome1> createState() => _Chefathome1State();
}

class _Chefathome1State extends State<Chefathome1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Chefathome2()),
                );
              },
              style: ButtonStyle(
