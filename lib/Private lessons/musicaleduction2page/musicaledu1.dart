...
import 'package:flutter_application_1/Private%20lessons/philosphy2page/phiklosphy2.dart';
import 'package:flutter_application_1/Private%20lessons/plastic2pages/plastic2.dart';
import 'package:flutter_application_1/Private%20lessons/soe2page/soe2.dart';
import 'package:flutter_application_1/Private%20lessons/svt2page/svt2.dart';
...
import 'musicaledu2.dart';



class Musicaledu1 extends StatefulWidget {
  const Musicaledu1({Key? key}) : super(key: key);

  @override
  State<Musicaledu1> createState() => _Musicaledu1State();
}

class _Musicaledu1State extends State<Musicaledu1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Musicaledu2()),
                );
              },
              style: ButtonStyle(
