...
class Spanish2 extends StatefulWidget {
  const Spanish2({Key? key}) : super(key: key);

  @override
  State<Spanish2> createState() => _Spanish2State();
}

class _Spanish2State extends State<Spanish2> {
  @override
