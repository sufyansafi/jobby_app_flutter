...
class Philosphy2 extends StatefulWidget {
  const Philosphy2({Key? key}) : super(key: key);

  @override
  State<Philosphy2> createState() => _Philosphy2State();
}

class _Philosphy2State extends State<Philosphy2> {
  @override
