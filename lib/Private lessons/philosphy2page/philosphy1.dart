...
class Philsophy1 extends StatefulWidget {
  const Philsophy1({Key? key}) : super(key: key);

  @override
  State<Philsophy1> createState() => _Philsophy1State();
}

class _Philsophy1State extends State<Philsophy1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Philosphy2()),
                );
              },
              style: ButtonStyle(
