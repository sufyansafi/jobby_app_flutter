...
class French2 extends StatefulWidget {
  const French2({Key? key}) : super(key: key);

  @override
  State<French2> createState() => _French2State();
}

class _French2State extends State<French2> {
  @override
