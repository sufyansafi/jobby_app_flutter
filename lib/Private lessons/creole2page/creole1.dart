...
import 'package:flutter_application_1/Private%20lessons/creole2page/creole2.dart';
...
class Creole1 extends StatefulWidget {
  const Creole1({Key? key}) : super(key: key);

  @override
  State<Creole1> createState() => _Creole1State();
}

class _Creole1State extends State<Creole1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Creole2()),
                );
              },
              style: ButtonStyle(
