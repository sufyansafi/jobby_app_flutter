...
class Soe1 extends StatefulWidget {
  const Soe1({Key? key}) : super(key: key);

  @override
  State<Soe1> createState() => _Soe1State();
}

class _Soe1State extends State<Soe1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Soe2()),
                );
              },
              style: ButtonStyle(
