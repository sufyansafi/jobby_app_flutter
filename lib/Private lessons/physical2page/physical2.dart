...
class Phyical2 extends StatefulWidget {
  const Phyical2({Key? key}) : super(key: key);

  @override
  State<Phyical2> createState() => _Phyical2State();
}

class _Phyical2State extends State<Phyical2> {
  @override
  var dropdownValue;
  int groupValue = 0;
