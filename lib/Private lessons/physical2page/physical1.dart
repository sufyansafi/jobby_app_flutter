...
class Physical1 extends StatefulWidget {
  const Physical1({Key? key}) : super(key: key);

  @override
  State<Physical1> createState() => _Physical1State();
}

class _Physical1State extends State<Physical1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Svt2()),
                );
              },
              style: ButtonStyle(
