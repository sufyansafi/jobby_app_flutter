...
import 'package:flutter_application_1/Private%20lessons/spanish2.dart';
...
class Spanish1 extends StatefulWidget {
  const Spanish1({Key? key}) : super(key: key);

  @override
  State<Spanish1> createState() => _Spanish1State();
}

class _Spanish1State extends State<Spanish1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Spanish2()),
                );
              },
              style: ButtonStyle(
