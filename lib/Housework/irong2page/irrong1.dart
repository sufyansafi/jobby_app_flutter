...
class Ironing1 extends StatefulWidget {
  const Ironing1({Key? key}) : super(key: key);

  @override
  State<Ironing1> createState() => _Ironing1State();
}

class _Ironing1State extends State<Ironing1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Irrong2()),
                );
              },
              style: ButtonStyle(
