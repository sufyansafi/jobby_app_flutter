...
import 'windowclen2.dart';

class Windowclean1 extends StatefulWidget {
  const Windowclean1({Key? key}) : super(key: key);

  @override
  State<Windowclean1> createState() => _Windowclean1State();
}

class _Windowclean1State extends State<Windowclean1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Windowclen2()),
                );
              },
              style: ButtonStyle(
