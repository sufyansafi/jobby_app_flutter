...
import 'otherclean2.dart';

class Otherclean1 extends StatefulWidget {
  const Otherclean1({Key? key}) : super(key: key);

  @override
  State<Otherclean1> createState() => _Otherclean1State();
}

class _Otherclean1State extends State<Otherclean1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Otherclean2()),
                );
              },
              style: ButtonStyle(
