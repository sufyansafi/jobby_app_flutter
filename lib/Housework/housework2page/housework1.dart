...
import 'housework2.dart';

class Housework1 extends StatefulWidget {
  const Housework1({Key? key}) : super(key: key);

  @override
  State<Housework1> createState() => _Housework1State();
}

class _Housework1State extends State<Housework1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Housework2()),
                );
              },
              style: ButtonStyle(
