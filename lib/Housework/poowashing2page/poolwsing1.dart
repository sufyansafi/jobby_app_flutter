...
import 'package:flutter_application_1/Housework/poowashing2page/poolwasing2.dart';
...
class Poolwash1 extends StatefulWidget {
  const Poolwash1({Key? key}) : super(key: key);

  @override
  State<Poolwash1> createState() => _Poolwash1State();
}

class _Poolwash1State extends State<Poolwash1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => poolwash2()),
                );
              },
              style: ButtonStyle(
