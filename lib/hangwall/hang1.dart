...
class Hangtv1 extends StatefulWidget {
  const Hangtv1({Key? key}) : super(key: key);

  @override
  State<Hangtv1> createState() => _Hangtv1State();
}

class _Hangtv1State extends State<Hangtv1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Hangtv2()),
                );
              },
              style: ButtonStyle(
