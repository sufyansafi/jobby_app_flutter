...
import 'keepotheranimal2.dart';




class Keepotheranimal1 extends StatefulWidget {
  const Keepotheranimal1({Key? key}) : super(key: key);

  @override
  State<Keepotheranimal1> createState() => _Keepotheranimal1State();
}

class _Keepotheranimal1State extends State<Keepotheranimal1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Keepotheranimal2()),
                );
              },
              style: ButtonStyle(
