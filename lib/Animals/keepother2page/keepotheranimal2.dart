...
class Keepotheranimal2 extends StatefulWidget {
  const Keepotheranimal2({Key? key}) : super(key: key);

  @override
  State<Keepotheranimal2> createState() => _Keepotheranimal2State();
}

class _Keepotheranimal2State extends State<Keepotheranimal2> {
  @override
