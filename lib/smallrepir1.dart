...
import 'Diy/Layout/smallrpr2.dart';
import 'hangpic2.dart';
import 'hangwall/hang2.dart';

class Smallrpr1 extends StatefulWidget {
  const Smallrpr1({Key? key}) : super(key: key);

  @override
  State<Smallrpr1> createState() => _Smallrpr1State();
}

class _Smallrpr1State extends State<Smallrpr1> {
  @override
  var dropdownValue;
