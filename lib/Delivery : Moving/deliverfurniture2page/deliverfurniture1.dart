...
import 'deliverfurniture2.dart';


class Deliverfurniture1 extends StatefulWidget {
  const Deliverfurniture1({Key? key}) : super(key: key);

  @override
  State<Deliverfurniture1> createState() => _Deliverfurniture1State();
}

class _Deliverfurniture1State extends State<Deliverfurniture1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Deliverfurnitur2()),
                );
              },
              style: ButtonStyle(
