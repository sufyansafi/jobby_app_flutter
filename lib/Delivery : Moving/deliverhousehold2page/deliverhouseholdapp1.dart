...
import 'package:flutter_application_1/Delivery%20:%20Moving/deliverhousehold2page/deliverhouseholdapp2.dart';
...
class Deliverhouseholdapp1 extends StatefulWidget {
  const Deliverhouseholdapp1({Key? key}) : super(key: key);

  @override
  State<Deliverhouseholdapp1> createState() => _Deliverhouseholdapp1State();
}

class _Deliverhouseholdapp1State extends State<Deliverhouseholdapp1> {
  @override
  var dropdownValue;
  int groupValue = 0;
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => Deliverhouseholdapp2()),
                );
              },
              style: ButtonStyle(
