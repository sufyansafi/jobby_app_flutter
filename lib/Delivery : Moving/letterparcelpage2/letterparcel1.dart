...
import 'letterparcel2.dart';


class Letter1 extends StatefulWidget {
  const Letter1({Key? key}) : super(key: key);

  @override
  State<Letter1> createState() => _Letter1State();
}

class _Letter1State extends State<Letter1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Letter2()),
                );
              },
              style: ButtonStyle(
