...
import 'movepiecefurniture2.dart';




class Moveapiecefurniture1 extends StatefulWidget {
  const Moveapiecefurniture1({Key? key}) : super(key: key);

  @override
  State<Moveapiecefurniture1> createState() => _Moveapiecefurniture1State();
}

class _Moveapiecefurniture1State extends State<Moveapiecefurniture1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>  Movepiecefirniture2()),
                );
              },
              style: ButtonStyle(
