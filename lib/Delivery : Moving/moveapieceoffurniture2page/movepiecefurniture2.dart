...
class Movepiecefirniture2 extends StatefulWidget {
  const Movepiecefirniture2({Key? key}) : super(key: key);

  @override
  State<Movepiecefirniture2> createState() => _Movepiecefirniture2State();
}

class _Movepiecefirniture2State extends State<Movepiecefirniture2> {
  @override
