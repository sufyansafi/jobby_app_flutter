...
class Otherremoval1 extends StatefulWidget {
  const Otherremoval1({Key? key}) : super(key: key);

  @override
  State<Otherremoval1> createState() => _Otherremoval1State();
}

class _Otherremoval1State extends State<Otherremoval1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Otherremoval2()),
                );
              },
              style: ButtonStyle(
