...
class Movingassistance2 extends StatefulWidget {
  const Movingassistance2({Key? key}) : super(key: key);

  @override
  State<Movingassistance2> createState() => _Movingassistance2State();
}

class _Movingassistance2State extends State<Movingassistance2> {
  @override
