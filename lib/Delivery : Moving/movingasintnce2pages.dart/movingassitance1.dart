...
import 'movingassistnce2.dart';

class Moveassistance1 extends StatefulWidget {
  const Moveassistance1({Key? key}) : super(key: key);

  @override
  State<Moveassistance1> createState() => _Moveassistance1State();
}

class _Moveassistance1State extends State<Moveassistance1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Movingassistance2()),
                );
              },
              style: ButtonStyle(
