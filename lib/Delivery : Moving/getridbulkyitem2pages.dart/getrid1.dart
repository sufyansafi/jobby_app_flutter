...
class Getrid1 extends StatefulWidget {
  const Getrid1({Key? key}) : super(key: key);

  @override
  State<Getrid1> createState() => _Getrid1State();
}

class _Getrid1State extends State<Getrid1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Getrid2()),
                );
              },
              style: ButtonStyle(
