...
class Getrid2 extends StatefulWidget {
  const Getrid2({Key? key}) : super(key: key);

  @override
  State<Getrid2> createState() => _Getrid2State();
}

class _Getrid2State extends State<Getrid2> {
  @override
