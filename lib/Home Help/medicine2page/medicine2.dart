...
class Medicine2 extends StatefulWidget {
  const Medicine2({Key? key}) : super(key: key);

  @override
  State<Medicine2> createState() => _Medicine2State();
}

class _Medicine2State extends State<Medicine2> {
  @override
