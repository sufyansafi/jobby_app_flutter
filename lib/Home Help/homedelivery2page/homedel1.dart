...
import 'homedel2.dart';

class Homedel1 extends StatefulWidget {
  const Homedel1({Key? key}) : super(key: key);

  @override
  State<Homedel1> createState() => _Homedel1State();
}

class _Homedel1State extends State<Homedel1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Homedel2()),
                );
              },
              style: ButtonStyle(
