...
class Homedel2 extends StatefulWidget {
  const Homedel2({Key? key}) : super(key: key);

  @override
  State<Homedel2> createState() => _Homedel2State();
}

class _Homedel2State extends State<Homedel2> {
  @override
