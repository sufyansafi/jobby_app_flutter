...
import 'package:flutter_application_1/Home%20Help/sewing2pages/sewing2.dart';
...
class Sewingalter1 extends StatefulWidget {
  ...
  @override
  State<Sewingalter1> createState() => _Sewingalter1State();
}

class _Sewingalter1State extends State<Sewingalter1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Sewing2()),
                );
              },
              style: ButtonStyle(
