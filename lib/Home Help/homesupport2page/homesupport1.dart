...
import 'homesuport2.dart';

class Homesuport1 extends StatefulWidget {
  const Homesuport1({Key? key}) : super(key: key);

  @override
  State<Homesuport1> createState() => _Homesuport1State();
}

class _Homesuport1State extends State<Homesuport1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Homesuport2()),
                );
              },
              style: ButtonStyle(
