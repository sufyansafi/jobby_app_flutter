...
class WaiterWaitress1 extends StatefulWidget {
  const WaiterWaitress1({Key? key}) : super(key: key);

  @override
  State<WaiterWaitress1> createState() => _WaiterWaitress1State();
}

class _WaiterWaitress1State extends State<WaiterWaitress1> {
  @override
  var dropdownValue;
  int groupValue = 0;
