...
import 'acompmedical2.dart';



class Accompmedical1 extends StatefulWidget {
  const Accompmedical1({Key? key}) : super(key: key);

  @override
  State<Accompmedical1> createState() => _Accompmedical1State();
}

class _Accompmedical1State extends State<Accompmedical1> {
  @override
  var dropdownValue;
  int groupValue = 0;
      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                "Accompagnement to medical apppoinments",
                style: TextStyle(
                  color: Colors.black87,
                  fontWeight: FontWeight.bold,
                  fontSize: 35,
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Accompmedical2()),
                );
              },
              style: ButtonStyle(
