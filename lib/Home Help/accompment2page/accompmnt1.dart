...
import 'accompmnt2.dart';

class Accomp1 extends StatefulWidget {
  const Accomp1({Key? key}) : super(key: key);

  @override
  State<Accomp1> createState() => _Accomp1State();
}

class _Accomp1State extends State<Accomp1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Accomp2()),
                );
              },
              style: ButtonStyle(
