...
class Accomp2 extends StatefulWidget {
  const Accomp2({Key? key}) : super(key: key);

  @override
  State<Accomp2> createState() => _Accomp2State();
}

class _Accomp2State extends State<Accomp2> {
  @override
