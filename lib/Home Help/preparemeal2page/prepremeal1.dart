...
class Preparemeal1 extends StatefulWidget {
  const Preparemeal1({Key? key}) : super(key: key);

  @override
  State<Preparemeal1> createState() => _Preparemeal1State();
}

class _Preparemeal1State extends State<Preparemeal1> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Preparemeal2()),
                );
              },
              style: ButtonStyle(
