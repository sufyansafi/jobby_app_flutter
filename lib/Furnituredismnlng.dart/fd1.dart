...
class Fdone extends StatefulWidget {
  const Fdone({Key? key}) : super(key: key);

  @override
  State<Fdone> createState() => _FdoneState();
}

class _FdoneState extends State<Fdone> {
  @override
  var dropdownValue;
  int groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Fdtwo()),
                );
              },
              style: ButtonStyle(
