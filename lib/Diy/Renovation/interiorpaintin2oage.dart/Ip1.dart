...
class Ip1 extends StatefulWidget {
  const Ip1({Key? key}) : super(key: key);

  @override
  State<Ip1> createState() => _Ip1State();
}

class _Ip1State extends State<Ip1> {
  @override
  var dropdownValue;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Ip2()),
                );
              },
              style: ButtonStyle(
