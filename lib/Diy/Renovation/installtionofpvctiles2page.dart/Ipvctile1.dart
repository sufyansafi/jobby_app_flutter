...
import 'Ipvctiles2.dart';



class Ipvctile1 extends StatefulWidget {
  const Ipvctile1({Key? key}) : super(key: key);

  @override
  State<Ipvctile1> createState() => _Ipvctile1State();
}

class _Ipvctile1State extends State<Ipvctile1> {
  @override
  var dropdownValue;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Ipvctiles2()),
                );
              },
              style: ButtonStyle(
