...
class Lop1 extends StatefulWidget {
  const Lop1({Key? key}) : super(key: key);

  @override
  State<Lop1> createState() => _Lop1State();
}

class _Lop1State extends State<Lop1> {
  @override
  var dropdownValue;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Lop2()),
                );
              },
              style: ButtonStyle(
