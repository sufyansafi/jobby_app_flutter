...
import 'chngefucet2.dart';

class Changefucet1 extends StatefulWidget {
  const Changefucet1({Key? key}) : super(key: key);

  @override
  State<Changefucet1> createState() => _Changefucet1State();
}

class _Changefucet1State extends State<Changefucet1> {
  var dropdownValue;
  var groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Changefucet2()),
                );
              },
              style: ButtonStyle(
