...
import 'chngeflush2.dart';

class Chnangflush1 extends StatefulWidget {
  const Chnangflush1({Key? key}) : super(key: key);

  @override
  State<Chnangflush1> createState() => _Chnangflush1State();
}

class _Chnangflush1State extends State<Chnangflush1> {
  var dropdownValue;
  var groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Changeflush2()),
                );
              },
              style: ButtonStyle(
