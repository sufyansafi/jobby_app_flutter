...
class Repair1toilet extends StatefulWidget {
  const Repair1toilet({Key? key}) : super(key: key);

  @override
  State<Repair1toilet> createState() => _Repair1toiletState();
}

class _Repair1toiletState extends State<Repair1toilet> {
  var dropdownValue;
  var groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Repairtoilet2()),
                );
              },
              style: ButtonStyle(
