...
import '../Layout/furnitureassembly3.dart';
import 'repairwater2.dart';

class Repair1 extends StatefulWidget {
  const Repair1({Key? key}) : super(key: key);

  @override
  State<Repair1> createState() => _Repair1State();
}

class _Repair1State extends State<Repair1> {
  var dropdownValue;
  var groupValue = 0;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Repair2()),
                );
              },
              style: ButtonStyle(
