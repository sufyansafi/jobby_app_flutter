...
import 'instaltionofelectricaloutlets2pag.dart/intalltnofelectricloutlet2.dart';

class Tclb2 extends StatefulWidget {
  const Tclb2({Key? key}) : super(key: key);

  @override
  State<Tclb2> createState() => _Tclb2State();
}

class _Tclb2State extends State<Tclb2> {
  @override
  var dropdownValue;
