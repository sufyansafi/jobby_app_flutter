...
import 'intalltnofelectricloutlet2.dart';

class Ioeo1 extends StatefulWidget {
  const Ioeo1({Key? key}) : super(key: key);

  @override
  State<Ioeo1> createState() => _Ioeo1State();
}

class _Ioeo1State extends State<Ioeo1> {
  @override
  var dropdownValue;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Ioeu2()),
                );
              },
              style: ButtonStyle(
