...
import 'package:flutter_application_1/Diy/Electricity/automtion2pge.dart/automtion2.dart';
...
class Automatn1 extends StatefulWidget {
  const Automatn1({Key? key}) : super(key: key);

  @override
  State<Automatn1> createState() => _Automatn1State();
}

class _Automatn1State extends State<Automatn1> {
  @override
  var dropdownValue;
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Automatn2()),
                );
              },
              style: ButtonStyle(
