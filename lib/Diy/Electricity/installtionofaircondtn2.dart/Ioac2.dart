...
class Ioac2 extends StatefulWidget {
  const Ioac2({Key? key}) : super(key: key);

  @override
  State<Ioac2> createState() => _Ioac2State();
}

class _Ioac2State extends State<Ioac2> {
  @override
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  "Installtion of an air conditioner",
                  style: TextStyle(
                    color: Colors.black87,
                    fontWeight: FontWeight.bold,
                    fontSize: 35,
